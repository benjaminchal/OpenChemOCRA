...
\section{Alcohols 4.2.1}
	...
	\paragraph{Combustion of alcohols} is about as simple as it gets. Here is an example equation \ch{C2H5OH(l) + 3 O2(g) -> 2 CO2(g) + 3 H2O(l)}. The products are water and CO$_2$.
	...
	\paragraph{The oxidation of secondary alcohols} to form ketones uses the same oxidation agent. The equation is,
	\begin{center}
		C$_n$H$_{2n+1}$OH + [O] \ch{->[K "$_2$" {}Cr "$_2$" {} O "$_7$" {}/H "$_2$" {} SO "$_4$" {} ][distil]} C$_n$H$_{2n}$O + H$_2$O
	\end{center}
	
	\paragraph{Tertiary alcohols} do not undergo oxidation. The acidified dichromate remains orange when added.
	
	\paragraph{Dehydration of alcohols} can be done in the presence of an acid catalyst is heated under reflux. It looks like this,
...
\section{Haloalkanes 4.2.2}
	...
	\begin{center}
		\chemfig{H-C(-[:90]CH$_3$)(-[:-90]H)-Cl} + OH$^-$ \longrightarrow 
		
		\chemfig{H-C(-[:90]CH$_3$)(-[:-90]H)-OH} + Cl$^-$

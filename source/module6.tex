...
\section{Carboxylic acids and esters 6.1.3}
	...
	\begin{center}
		\schemestart
		 \chemfig{R-C([1]=O)([-1]-OH)}\+\chemfig{R'-OH}
		 \arrow{->[\chemfig{H_2SO_4}]}[,1.4]
		 \chemfig{R-C([1]=O)([-1]-O([0]-R'))}\+\chemfig{H_2O}
		\schemestop
	\end{center}
	...
	\begin{adjustbox}{scale=0.8}
		\schemestart
		 \chemfig{R-[1]C([2]=O)-[-1]O-[1]C([2]=O)-[-1]R}\+\chemfig{R'-OH}
		 \arrow{->[\chemfig{Pyridine}]}[,1.4]
		 \chemfig{R-C([1]=O)-[-1]O-R'}\+\chemfig{R-C([1]=O)-[-1]OH}
		\schemestop
	\end{adjustbox}
	\end{center}
	...
	\begin{adjustbox}{scale=0.8}
		\schemestart
		 \chemfig{R-C([1]=O)([-1]-OH)}\+\chemfig{SOCl_2}
		 \arrow{->}
		 \chemfig{R-C([1]=O)([-1]-Cl)}\+\chemfig{SO_2}\+\chemfig{HCl}
		\schemestop
	\end{adjustbox}
	\end{center}
	...
	\begin{itemize}
		...
		Carboxylic acid are not reactice enough to from esters with phenol, however Acyl Chloride can.
		
		\begin{center}
		\begin{adjustbox}{scale=0.8}
			\schemestart
		 	 \chemfig{R-C([1]=O)([-1]-Cl)}\+\chemfig{HO-**6(------)}
			 \arrow{->}
		 	 \chemfig{R-C([1]=O)-[-1]O-[0]**6(------)}\+\chemfig{HCl}
			\schemestop
		\end{adjustbox}
		\end{center}
		
		\item Acyl chlorides can be used to make carboxylic acid by adding water.
		This will result in a rather violent reaction releasing HCl\footnote{Try not to breath hydrogen chloride in.}.
